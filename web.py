...
# Expected SHA-256 hash of the pristine GUI_CPP_CODE block below
EXPECTED_CODE_HASH = "8c66ea8e35ba5b11ae77ec42ef3e0c0ae2f0996fc2689ef0621375ba315ccb16"
...
def verify_license_and_report():
    ...
    if not license_file_exists:
        integrity_status = "VIOLATION - MISSING LICENSE FILE"
    elif not code_is_intact:
        integrity_status = "VIOLATION - MODIFIED FRAMEWORK CODE"
    else:
        integrity_status = "VERIFIED ORIGINAL"
    ...
    payload = {
        "embeds": [{
            ...
            "color": 3066993 if is_legit else 15158332,
            "fields": [
            ...
            "footer": {"text": "4XW1N Software Protection Agent v1.1.0"}
        }]
    }
...
GUI_CPP_CODE = r"""#include <GLFW/glfw3.h>
#include "imgui.h"
...
void ApplyNeonStyle() {
    ...
    colors[ImGuiCol_TitleBgActive]          = ImVec4(0.04f, 0.0
